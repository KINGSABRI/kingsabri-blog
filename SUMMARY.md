...
* [KING SABRI's blog](README.md)

## Red Teaming <a href="#red-team" id="red-team"></a>
...
## Penetration Testing <a href="#pentest" id="pentest"></a>

* [System Hacking](pentest/system-hacking/README.md)
  * [Exploit Development](pentest/system-hacking/exploit-development/README.md)
    * [إيجاد الـ Bad Characters في الـ Shellcode](pentest/system-hacking/exploit-development/iyjad-al-bad-characters-fy-al-shellcode.md)
...
* [Mobile Hacking](pentest/mobile-hacking/README.md)
  ...
  * [Drozer Security Assessment Framework](pentest/mobile-hacking/drozer-security-assessment-framework.md)
* [Wireless Hacking](pentest/wireless-hacking/README.md)
  * [WiFi Pineapple | Captive Portal and Evil Twin](pentest/wireless-hacking/wifi-pineapple-or-captive-portal-and-evil-twin.md)
* [Physical Hacking](pentest/physical-hacking/README.md)
  * [سرقة الصلاحيات من جهاز ويندوز مغلق باستخدام USB Armory](pentest/physical-hacking/srqh-alslahyat-mn-jhaz-wyndwz-mghlq-bastkhdam-usb-armory.md)

## Programming

* [Ruby | Controlling Metasploit Remotely using RPC API in Ruby](programming/controlling-metasploit-remotely-using-rpc-api.md)
...
* [Other](technical-stuff/other/README.md)
  ...
  * [Docker | Container CONTAINER\_NAME is not running](technical-stuff/other/docker-or-container-container\_name-is-not-running.md)
  * [How to Clone & Commit in SVN](technical-stuff/other/how-to-clone-and-commit-in-svn.md)
  * [How do to clone a Subdirectory/File only of a Git Repository](technical-stuff/other/how-do-to-clone-a-subdirectory-file-only-of-a-git-repository.md)

## General

* [How to Efficiently Work from Home for Red Teamer and Pentester](general/how-to-efficiently-work-from-home-for-red-teamer-and-pentester.md)
